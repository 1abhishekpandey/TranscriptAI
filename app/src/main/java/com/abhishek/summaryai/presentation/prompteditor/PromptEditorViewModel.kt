        ...
        when (validationResult) {
            is ValidatePromptUseCase.ValidationResult.Valid -> {
                viewModelScope.launch {
                    ...
                    if (result is com.abhishek.summaryai.domain.model.Result.Success) {
                        Logger.logI("PromptEditorViewModel: Prompt saved successfully")
                        onShowToast(SummariserConstants.MESSAGE_PROMPT_SAVED)
                        startNewPrompt()
                    } else if (result is com.abhishek.summaryai.domain.model.Result.Error) {
    ...
    private fun confirmDelete() {
        ...
        viewModelScope.launch {
            ...
            when (result) {
                ...
                is com.abhishek.summaryai.domain.model.Result.Error -> {
